...
class Permission {
    ...
    public function handle($request, Closure $next) {
        ...
        if ($user_type == 'admin' || $user_type == 'user'||$user_type == 'super_admin' ) {
            ...
            if ($route_name != '' && $user_type == 'user') {
                ...
                if (!has_permission($route_name)) {
                    if (!$request->ajax()) {
                        ...
                        return new Response('<h4 class="text-center">Permission denied</h4>');
                    }
                }
            }
        } else {
            if (!$request->ajax()) {
                ...
                return new Response('<h5 class="text-center">Permission denied !</h5>');
            }
        }
